...
public interface AlbumService {
   ...
   Page<AlbumDTO> getAllCategories(Pageable pageable, String title, String artist, Integer year);

   Page<AlbumDTO> getAllCategories(Pageable pageable, String title, String artist, Integer year, String... with);
